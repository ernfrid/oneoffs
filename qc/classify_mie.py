...
class MIE(object):
    ...
    def __call__(self, fields):
        ...
        dad_alleles, mom_alleles = map(set, (dad, mom))
        if len(dad_alleles) == 2 and len(mom_alleles) == 2:
            # both are het, this site is UNINFORMATIVE assuming input is bi-allelic and includes no missing genotypes
            raise Uninformative
        a1, a2 = kid
        classification = 'MIE'
